...
private:
    ...
    void PaddingBumps(const vector<Bump>& bumps, vector<Bump>& paddingBumps, double minimumHorizontalSpace) ; //生成 Padding Bump使其可以順利三角化
...
public:
    ...
    vector<Bump> bumps ; 
    vector<RoutingGraph> routingGraphs
